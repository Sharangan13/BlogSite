...
export default function BlogDetails() {
  ...
  return (
    <Fragment>
      ...
      <article className="max-w-[780px] mx-auto my-12 px-8">
        <p className="text-xs font-bold tracking-widest uppercase text-blue-600 mb-3">{blog.category}</p>
        <h1 className="text-3xl md:text-4xl font-bold leading-snug mb-4 text-gray-900">{blog.title}</h1>
        <div className="flex gap-5 items-center text-sm text-gray-400 mb-8 pb-5 border-b border-gray-200">
        ...
        />
        <div className="text-[1.08rem] leading-relaxed text-gray-600">
          {blog.body.split('\n').map((para, i) =>
