...
const cardCls = "bg-white border border-gray-200 rounded-2xl p-8 sm:p-10 w-full max-w-[440px] shadow-md flex flex-col gap-5";
      ...
      <div className={pageCls}>
        <form className={cardCls} onSubmit={handleSubmit}>
          ...
          <div className="flex flex-col gap-2">
            ...
            <input type="password" required value={oldPassword} onChange={(e) => setOldPassword(e.target.value)} placeholder="••••••••" className={inputCls} />
          </div>
          <div className="flex flex-col gap-2">
