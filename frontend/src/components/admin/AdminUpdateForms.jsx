      ...
      <div className="flex min-h-[calc(100vh-64px)]">
        ...
        <div className="flex-1 px-4 sm:px-8 py-6 sm:py-10">
          ...
          <button
            type="button"
            onClick={() => navigate(-1)}
            className="inline-flex items-center gap-1.5 text-sm text-gray-500 hover:text-blue-600 transition-colors border-none bg-transparent cursor-pointer p-0 mb-4"
          >
          ...
          <h1 className="text-2xl font-bold mb-6 sm:mb-8 text-gray-900" style={{ fontFamily: 'var(--font-display)' }}>{title}</h1>
          {loading ? <Loader /> : (
            <div className="max-w-[480px]">
              <form className="bg-white border border-gray-200 rounded-2xl p-6 sm:p-10 flex flex-col gap-5" onSubmit={handleSubmit}>
                <div className="flex flex-col gap-2">
                  <label className="text-sm font-semibold text-gray-600">Name</label>
                  <input name="name" type="text" value={fields.name} onChange={onChange} className={inputCls} />
                </div>
                <div className="flex flex-col gap-2">
                  <label className="text-sm font-semibold text-gray-600">Email</label>
                  <input name="email" type="email" value={fields.email} onChange={onChange} className={inputCls} />
                </div>
                <div className="flex flex-col gap-2">
