...
import {
    blogFail, blogRequest, blogSuccess,
    createBlogFail, createBlogRequest, createBlogSuccess,
    deleteBlogFail, deleteBlogRequest, deleteBlogSuccess,
...
export const getblog = (id) => async (dispatch) => {
    try {
        ...
        dispatch(blogFail(error.response?.data?.message || 'Failed to load blog'));
    }
};
...
export const createNewBlog = (blogData) => async (dispatch) => {
    try {
        ...
        dispatch(createBlogFail(error.response?.data?.message || 'Failed to create blog'));
    }
};
...
export const deleteBlog = (id) => async (dispatch) => {
    try {
        ...
        dispatch(deleteBlogFail(error.response?.data?.message || 'Failed to delete blog'));
    }
};
...
export const deleteMyBlog = (id) => async (dispatch) => {
    try {
        ...
        dispatch(deleteMyBlogFail(error.response?.data?.message || 'Failed to delete blog'));
    }
};
...
export const authorUpdateBlog = (id, blogData) => async (dispatch) => {
    try {
        ...
        dispatch(updateBlogFail(error.response?.data?.message || 'Failed to update blog'));
    }
};
